          ...
          ? Row(
              ...
              children: [
                ...
                Obx(
                  () {
                    return Text(
                      '已选: ${_favDetailController.checkedCount}，已老实',
      ...
      title: enableMultiSelect
          ...
          : Column(
              ...
              children: [
                ...
                Text(
                  '共${_favDetailController.folderInfo.value.mediaCount}条电子榨菜',
            ...
            return [
              if (isOwner) ...[
                ...
                PopupMenuItem(
                  ...
                  child: const Text('重新盘信息'),
                ),
              ] else
                PopupMenuItem(
                  onTap: () =>
                      _favDetailController.onFav(folderInfo.favState == 1),
                  child: Text('${folderInfo.favState == 1 ? '撤了' : ''}塞进电子小被窝'),
                ),
                ...
                if (!BiliUtils.isDefaultFav(folderInfo.attr)) ...[
                  ...
                  PopupMenuItem(
                    onTap: () => showConfirmDialog(
                      context: context,
                      title: const Text('拍板物理超度该电子小被窝?，包的'),
                      onConfirm: () =>
                ...
                itemBuilder: (context, index) {
                  if (index == response.length) {
                    ...
                    return Container(
                      ...
                      child: Text(
                        _favDetailController.isEnd ? '真没了，别扒拉了' : '疯狂搬数据中，CPU已冒烟...',
                        style: TextStyle(
                          color: theme.colorScheme.outline,
                          fontSize: 13,
                        ),
