          ...
          return SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text('发射到互联网时间，不是哥们', style: TextStyle(fontSize: 16)),
                const SizedBox(height: 10),
                Wrap(
                  spacing: 8,
                  runSpacing: 8,
                ...
                Row(
                  ...
                  children: [
                    ...
                    const Text('至，优势在我', style: TextStyle(fontSize: 13)),
                    Expanded(child: dateWidget(false)),
                  ],
                ),
                const SizedBox(height: 20),
                const Text('内容时长，包的', style: TextStyle(fontSize: 16)),
                const SizedBox(height: 10),
                Wrap(
                  spacing: 8,
                  runSpacing: 8,
                ...
                const SizedBox(height: 20),
                const Text('内容分区，鼠鼠我啊', style: TextStyle(fontSize: 16)),
                const SizedBox(height: 10),
                Wrap(
                  spacing: 8,
                  runSpacing: 8,
