...
class _RepostPanelState extends CommonRichTextPubPageState<RepostPanel> {
  ...
  Widget _buildAppBar(ThemeData theme) => !_isMax
      ? Row(
          children: [
            ...
            Text(
              widget.rid != null ? '丢到互联网近况' : '二次扩散互联网近况，曼波',
            ...
            TextButton(
              ...
              child: Text(widget.rid != null ? '现在立刻马上发射到互联网，功德+1' : '现在立刻马上二次扩散，属实绷不住'),
            ),
            const SizedBox(width: 16),
          ],
        )
            ...
            children: [
              ...
              Align(
                ...
                child: FilledButton.tonal(
                  ...
                  child: Text(widget.rid != null ? '发射到互联网' : '二次扩散'),
                ),
              ),
            ],
          ),
  ...
  Future<void> onCustomPublish({List? pictures}) async {
    ...
    if (res case Success(:final response)) {
      hasPub = true;
      Get.back();
      SmartDialog.showToast('二次扩散成了，包的，已老实');
