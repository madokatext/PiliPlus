    ...
    showDialog(
      ...
      builder: (context) => SimpleDialog(
        ...
        children: [
          ListTile(
            dense: true,
            title: const Text('薅到剪贴板', style: style),
            onTap: () {
              Get.back();
          ...
          ListTile(
            dense: true,
            title: const Text('薅成赛博卷宗落地', style: style),
            onTap: () {
              Get.back();
              exportToLocalFile(
                onExport: _onExport,
    ...
    showDialog(
      ...
      builder: (context) => SimpleDialog(
        ...
        children: [
          ListTile(
            dense: true,
            title: const Text('从剪贴板往里灌', style: style),
            onTap: () {
              Get.back();
          ...
          ListTile(
            dense: true,
            title: const Text('从自家硬盘赛博卷宗往里灌', style: style),
            onTap: () {
              Get.back();
