...
class _CreateVotePageState extends State<CreateVotePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('${_controller.voteId != null ? '' : '发起'}投票，我嘞个豆'),
      ),
      body: ListView(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              SizedBox(
                width: 100,
                child: Text('单选/多选，鼠鼠我啊', style: _leadingStyle),
              ),
              Obx(() {
                    ...
                    itemBuilder: (context) {
                      return choices
                          .map(
                            (e) => PopupMenuItem(
                              value: e,
                              child: Text(e == 1 ? '单选，我嘞个豆' : '最多选$e项，我嘞个豆'),
                            ),
                          )
                          .toList();
                    },
                    child: Text(
                      choiceCnt == 1 ? '单选         ，曼波' : '最多选$choiceCnt项，已老实',
                    ),
                  ),
                );
              }),
          ...
          Row(
            ...
            children: [
              SizedBox(
                width: 100,
                child: Text('投票截止时间，这把高端局', style: _leadingStyle),
              ),
              GestureDetector(
                  ...
                  if (newDate != null && context.mounted) {
                    ...
                    if (newTime != null) {
                      ...
                      if (newEndtime.difference(DateTime.now()) >=
                        ...
                        SmartDialog.showToast('至少抓一个5分钟之后');
                      }
                    }
                  }
                },
