...
class _CreateReservePageState extends State<CreateReservePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('塞一个赛博围观预约')),
      body: ListView(
        ...
        children: [
          Row(
            ...
            children: [
              SizedBox(
                width: 65,
                child: Text('类型，属实绷不住', style: _leadingStyle),
              ),
              Obx(
                () => PopupMenuButton(
                  requestFocus: false,
                  ...
                  child: Text(
                    _controller.subType.value == 0 ? '全网裸奔赛博围观，曼波' : '大航海赛博围观',
                  ),
                ),
              ),
            ],
          ...
          Row(
            ...
            children: [
              SizedBox(
                width: 65,
                child: Text('时间线', style: _leadingStyle),
              ),
              Expanded(
